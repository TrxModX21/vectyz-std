...
export const updateStockMetadataSchema = z.object({
  ...
  categoryId: z.cuid2("Choose 1 category"),
  fileTypeId: z.cuid2("Choose 1 file type"),
  keywords: z
    .array(z.string())
...
export type UpdateStockMetadataSchema = z.infer<
  typeof updateStockMetadataSchema
>;
