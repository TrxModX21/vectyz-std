...
import UploadInstructionCard from "@/components/upload-instruction-card";
...
const UploadStock = ({ open, onOpenChange }: Props) => {
    ...
    >
      <DrawerContent className="pb-5">
        <DrawerHeader className="gap-1">
          <DrawerTitle className="sr-only">Upload Files Form</DrawerTitle>
          <DrawerDescription className="border-b-2 sr-only">
            Fil all form to upload your files
          </DrawerDescription>
        </DrawerHeader>
          ...
          >
            ...
            <Field className="space-y-2">
              ...
              {form.formState.errors.preview && (
                <FieldError>{form.formState.errors.preview.message}</FieldError>
              )}
            </Field>
            ...
            <Field>
              ...
              <div className="space-y-3">
                <div className="rounded-lg border border-dashed p-4">
                  <div className="flex flex-col items-center justify-center gap-2 text-muted-foreground">
                    ...
                    <Input
                      ...
                      disabled={isPending || selectedOriginalFiles.length >= 3}
                  ...
                  {selectedOriginalFiles.length > 0 && (
                    <div className="mt-3 grid gap-2">
                      {selectedOriginalFiles.map((file, index) => (
                        <div
                          key={index}
                          className="flex items-center justify-between rounded-md border bg-muted/40 p-2 text-sm max-w-xs"
                        >
                ...
                <div className="mt-1 text-xs text-muted-foreground">
                  ...
                  .cdr), Figma (.fig), Photoshop (.psd, .psb), PowerPoint (.ppt,
                  .pptx), Zip (.zip), Images.
                </div>
              </div>
