...
import PublishedTable from "@/components/vectyzen/stocks/published/table";
...
import { ArrowDownUp, ImagePlus, Search, SlidersHorizontal, X } from "lucide-react";
          ...
          <CardHeader>
            <div className="flex flex-col lg:flex-row gap-6 item-start lg:items-center justify-between">
              <div>
                ...
                <CardDescription>
                  This page show list of your pending review asset.
                </CardDescription>
              </div>
