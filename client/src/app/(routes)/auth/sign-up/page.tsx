...
import { RegisterSchema, registerSchema } from "@/validators/auth.validation";
...
const SignUpPage = () => {
  ...
  const onSubmit = async (values: RegisterSchema) => {
    ...
    const generatedName = `Vectyzen ${randomSuffix}`;
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <FieldGroup>
            ...
            <Field>
              ...
              <div className="relative">
                <Input
                  ...
                  className="rounded-full h-11 border-gray-300 focus-visible:ring-2 focus-visible:ring-blue-600 pr-10"
                  placeholder="*********"
            ...
            <Field>
              <div className="space-y-2 flex gap-2 items-start pt-2">
                <Controller
                ...
                <div className="grid gap-1.5 leading-none">
                  <label
                    ...
                    className="text-xs font-medium text-gray-700 leading-normal"
                  >
                    I agree with Privacy Policy, Terms of Service, Conditions,
                    DMCA, Licensing Agreement, Terms of Use
                  </label>
                </div>
              </div>
            ...
            <Button
              ...
              type="submit"
              className="w-full h-11 rounded-full bg-[#0047AB] hover:bg-blue-600 text-white font-semibold shadow-md mt-4"
            >
